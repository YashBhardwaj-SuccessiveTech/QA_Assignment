...
Then(
    ...
    async function (this: CustomWorld) {
        ...
        await this.pages.homePage
            .verifyHeaderNavigationMenu();
    }
);

Then(
    "Home page slider should be visible",
    async function (this: CustomWorld) {
...
Then(
    ...
    async function (this: CustomWorld) {
        ...
        await this.pages.homePage
            .verifyCategoryAndProductAlignment();
    }
);
