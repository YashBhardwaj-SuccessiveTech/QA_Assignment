...
export class ContactPage {
    ...
    constructor(page: Page) {
        ...
        this.contactHeader = page.getByRole('heading', { name: 'Get In Touch', exact: false });
        ...
        this.successStatusAlert = page.locator('.contact-form .status.alert-success');
    }
    ...
    async submitContactFormWithDialogHandler(): Promise<void> {
        ...
        this.page.once('dialog', async (dialog) => {
            console.log(`[Dialog Intercepted Successfully] Text: ${dialog.message()}`);
    ...
    async verifyFormSubmissionSuccess(expectedSuccessMessage: string): Promise<void> {
        ...
        await expect(this.successStatusAlert).toHaveText(new RegExp(expectedSuccessMessage.trim(), 'i'), { timeout: 7000 });
    }
}