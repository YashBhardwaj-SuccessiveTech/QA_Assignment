...
export class LoginPage {
  ...
  constructor(page: Page) {
    ...
    this.loginFormSection = page.locator(".login-form");

    this.signupFormSection = page.locator(".signup-form");
  ...
  async verifyLoginFormSection(): Promise<void> {
    await expect(this.loginFormSection).toBeVisible();
  }

  async verifySignupFormSection(): Promise<void> {
    await expect(this.signupFormSection).toBeVisible();
  }
  ...
  async enterSignupNameAndEmail(name: string, email: string): Promise<void> {
